...
<title>Schema (animiert) – Weihs</title>
<style>
...
<div class="bar">
  ...
  <div><h1>Schema – animiert</h1><div class="sub"><?= $data?h($data["projekt"]):"" ?> · Bauteil antippen → Kabelweg &amp; Verteiler</div></div>
  <div class="spacer"></div>
  <a class="btn" href="plan.php">📐 Echter Plan</a> <a class="btn" href="index.php">← Kabelliste</a>
</div>
